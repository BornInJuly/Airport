...
<body>
    <div class="wrapper_0_arr" id="main">
        <div class="black_notmain">
            <div class="central-part">
                <main>
                    <div class="onslide">
                        <div class="onslide-text">
                            <h1 class="hello_notmain">СПИСОК ПРИЛЕТАЮЩИХ РЕЙСОВ:</h1>
                        </div>
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-sm-12 all" style="overflow-x:auto; margin-right:15px;">
                                    <table class="table tablestyle">
                                        <thead>
                                           ...
                                           <?php
                                            ...
                                            $query = "SELECT * FROM arrival WHERE astatus = 1";
